...
<?php if ($config->validFields === ['email']): ?>
 ...
 <?php else: ?>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user <?php if(session('errors.login')) : ?>is-invalid<?php endif ?>" name="login"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
...
<?php if ($config->activeResetter): ?>
                                    <div class="text-center">
                                        <!-- <a class="small" href="forgot-password.html"><?=lang('AuthforgotYourPassword')?></a> -->
                                    </div>
<?php endif; ?>
